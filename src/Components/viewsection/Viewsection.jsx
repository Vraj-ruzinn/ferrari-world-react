...
const Viewsection = () => {
  ...
  <div className="bg-white">
    ...
    <div className="px-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
      {/* Card 1 */}
      <Reveal delay={100}>
        <div className="flex flex-col items-center bg-gray-50 p-6 rounded-lg shadow-sm h-full min-h-[300px]">
          ...
          <p className="text-gray-600 text-sm sm:text-[16px] leading-relaxed text-center">
